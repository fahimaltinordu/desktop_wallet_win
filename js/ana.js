...
// const provider = new ethers.providers.InfuraProvider("ropsten", "3a0bde1254514ca3a4f536ecdd311913"); // Replace this with your own Project ID
					...
					$('#providerselector').on('change',function(){
						...
						if ( $(this).val()==="etherscan") {
							provider = new ethers.providers.EtherscanProvider("ropsten", "R7R3Z7MMTMQC7J7H8NCNDX2UAAUPP9RU2X");
						} else if ( $(this).val()==="infura") {
							provider = new ethers.providers.InfuraProvider("ropsten", "3a0bde1254514ca3a4f536ecdd311913"); 
						} else if ( $(this).val()==="infura2") {
							provider = new ethers.providers.InfuraProvider("ropsten", "ec6d2493e2004b1f9723f2d11ddf356a"); 
						}else if ( $(this).val()==="etherscan2") {
							provider = new ethers.providers.EtherscanProvider("ropsten", "ZKD7XVVFSWG2GQ7AV2KABV8JXMIDWS8P3B"); 
						}
...
function LoadTransaction () {
	...
	var apitxlist = 'https://api-ropsten.etherscan.io/api?module=account&action=tokentx&contractaddress='+apicontract+'&address='+apiadress+'&page=1&offset=20&sort=desc&apikey=R7R3Z7MMTMQC7J7H8NCNDX2UAAUPP9RU2X';			
